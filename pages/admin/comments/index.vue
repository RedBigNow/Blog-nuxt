...
export default {
    ...
    created () {
        axios
            .get('https://blog-nuxt-5b600-default-rtdb.firebaseio.com/comments.json')
                .then((res) => {
                    let commentsArray = []
    ...
    methods: {
        ...
        changeComment (comment) {
            ...
            axios
                .put(`https://blog-nuxt-5b600-default-rtdb.firebaseio.com/comments/${comment.id}.json`, comment)
        },
        deleteComment (id) {
            axios
                .delete(`https://blog-nuxt-5b600-default-rtdb.firebaseio.com/comments/${id}.json`)
                    .then((res) => {
                        this.loadComments()
                    })
        }
